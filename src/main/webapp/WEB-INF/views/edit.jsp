		...
		<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
			<div class="card shadow-lg" id="card">
				<div class="card-body p-5">
					...
					<form:form method="POST" action="/show/update" modelAttribute="show">
					<form:input type="hidden" class="form-control" path="id"/>
						<div class="mb-3">
							<form:label class="mb-1 text-muted" path="showTittle">Re-enter the title</form:label>
						...
						<div class="mb-3">
							<form:label class="mb-1 text-muted" path="showNetwork">Re-enter the network</form:label>
